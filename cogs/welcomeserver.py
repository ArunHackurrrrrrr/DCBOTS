...
class Welcomeserver(commands.Cog):
    ...
    async def on_member_join(self, member: discord.Member):
        ...
        if welcome_channel is None:
            return  # Exit if no system channel is set
        ...
        bg.image.save("welcome.png")
        img_file = discord.File("welcome.png")
...
async def setup(bot):
    await bot.add_cog(Welcomeserver(bot))
